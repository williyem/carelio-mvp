...
/**
 * GET /api/health-assistant/patient/unassigned
 * Proxy endpoint for searching unassigned patients
 */
export async function GET(request: NextRequest) {
  try {
    ...
    console.error('Unassigned patients search error:', error);
    ...
    if (error instanceof Error && 'response' in error) {
      ...
      return NextResponse.json(
        {
          error: 'Searching unassigned patients failed',
