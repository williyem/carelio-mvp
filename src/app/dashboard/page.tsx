    ...
    <div className="space-y-10">
      ...
      <div className="space-y-5">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <h1 className="text-2xl font-bold leading-[1.2] tracking-tight text-(--text-primary)">
            Welcome back
          </h1>
          <div className="flex flex-wrap items-center gap-3 sm:gap-4">
            <Link href="/dashboard/schedule-appointment">
              <Button
                variant="outline"
                className="h-11 w-full sm:w-[168px] rounded-full border-brand-blue bg-(--bg-white) px-4 py-2.5 text-sm font-normal text-brand-blue hover:bg-brand-blue/5 hover:text-brand-blue"
              >
