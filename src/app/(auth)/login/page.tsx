...
export default function LoginPage() {
  ...
  const isStaffForm =
    loginRole === 'doctor' || loginRole === 'health-assistant';
  const staffForm =
    loginRole === 'doctor' ? doctorForm : healthAssistantForm;
  const isPending =
    loginRole === 'patient'
  ...
  return (
    <div className="flex items-center justify-center py-12 px-6 lg:px-8 w-full">
      <div className="mx-auto grid w-full max-w-[400px] gap-6">
        ...
        {loginRole === 'patient' ? (
          <form className="grid gap-4" onSubmit={patientForm.handleSubmit}>
            <div className="grid gap-2">
              <Label htmlFor="patientId" className="text-gray-500 font-normal">
                Patient ID
              </Label>
              <div className="relative">
                ...
                <Input
                  ...
                  {...patientForm.register('patientId')}
                />
              </div>
              <ErrorMessage
                message={patientForm.formState.errors.patientId?.message}
              />
            </div>
            ...
            <Button
              ...
              disabled={
                patientForm.isPending || !patientForm.formState.isValid
              }
            >
