...
export default function ForgotPasswordPage() {
  ...
  return (
    <div className="w-full flex flex-col items-center justify-center sm:p-6 bg-white dark:bg-background h-full">
      ...
      {/* Background decoration (faint shape) - Optional implementation */}
      <div className="fixed bottom-0 right-0 pointer-events-none opacity-50 z-[-1]">
        {/* SVG or Image could go here */}
      </div>
    </div>
  );
}
